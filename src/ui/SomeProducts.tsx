          ...
          <div className="flex flex-col gap-y-8 justify-center items-center">
            ...
            >
              ...
              <div className="flex flex-col justify-center items-center gap-y-8 md:items-start md:text-left md:translate-y-[20%]">
                ...
                <button className="bg-black text-white font-semibold px-6 py-3 text-medium">
                  SEE PRODUCT
                </button>
              </div>
            </div>
            ...
            <div
              className={`bg-[url('/public/assets/home/mobile/image-speaker-zx7.jpg')] sm:bg-[url('/public/assets/home/tablet/image-speaker-zx7.jpg')] md:bg-[url('/public/assets/home/desktop/image-speaker-zx7.jpg')] bg-no-repeat bg-center bg-cover md:h-[300px] h-[400px] w-full relative rounded-lg z-10 flex px-10 flex-col justify-center items-start text-center gap-y-8 md:gap-x-8 overflow-hidden`}
            >
              {/* <img
                src="/public/assets/home/desktop/image-speaker-zx7.jpg"
                alt="speacker"
              /> */}
              <h2 className="font-bold text-slate-950 md:text-4xl text-3xl tracking-wider">
                ZX7 Speaker
              </h2>
              <button className="border-2 border-slate-950  text-slate-950 font-semibold px-6 py-3 text-medium">
                SEE PRODUCT
              </button>
            </div>
